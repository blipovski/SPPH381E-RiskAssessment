...
This localized heating is the trigger for the subsequent chemical reactions in the coated layer of the paper, starting the colour development process in specific areas to create the desired print[^7] [^9] [^10].
...
As the leuco dye and developer are suspended in the PCM, they cannot interact[^7] [^9].
...
his event, called protonation, involves the developer donating hydrogen ions (protons) to the leuco dye[^9] [^10] [^11] [^12]. 
Adding a hydrogen ion changes the leuco dye’s structure, altering how the molecule interacts with light and thus its colour[^9] [^10] [^11] [^12]. 
...
The exact colour produced depends on the structure of the leuco dye and the nature of the protonation[^9] [^10].
...
After moving beyond the printhead, the PCM cools down and solidifies[^7] [^9]. 
