...
<table>
    <thead>
        <tr>
            <th>Chemical</th>
            <th>GHS Pictogram Description</th>
            <th>Hazard Statement‡</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>Fluorant† <a href="#41"><sup>41</sup></a></td>
            <td style="text-align: center;"><img src="/GHS07.png" alt="GHS07" /></td>
            </td>
            <td>H413 (100%)*</td>
        </tr>
        <tr>
            <td>Crystal Violet Lactone<a href="#42"><sup>42</sup></a></td>
            <td style="text-align: center;"><img src="/GHS07.png" alt="GHS07" /></td>
            </td style="text-align: center;">
            <td>H315 (88.39%)<br>H319 (88.39%)<br>H335 (100%)</td>
        </tr>
        <tr>
            <td>Bisphenol A (BPA)<a href="#43"><sup>43</sup></a></td>
            <td style="text-align: center;">
                <img src="/GHS05.png" alt="GHS05" style="display: inline-block;" />
                <img src="/GHS07.png" alt="GHS07" style="display: inline-block;" />
                <img src="/GHS08.png" alt="GHS08" style="display: inline-block;" />
                <img src="/GHS09.png" alt="GHS09" style="display: inline-block;" />
            </td>
            <td>H317 (99.92%)<br>H318 (99.92%)<br>H335 (100%)<br>H360 (19.31%)<br>H361 (79.66%)<br>H411 (12.97%)</td>
        </tr>
        <tr>
            <td>Bisphenol S (BPS)<a href="#44"><sup>44</sup></a></td>
            <td style="text-align: center;">
                <img src="/GHS07.png" alt="GHS07" style="display: inline-block;" />
                <img src="/GHS08.png" alt="GHS08" style="display: inline-block;" />
                <img src="/GHS09.png" alt="GHS09" style="display: inline-block;" />
            </td>
            <td>H360 (53.91%)<br>H360FD (91.74%)</td>
        </tr>
    </tbody>
</table>
...
>‡_Note: Part of the globally harmonized system of classification and labelling of chemicals (GHS), the hazard statement is a signal word and precautionary risk factor. Refer to the [PubChem glossary](https://pubchem.ncbi.nlm.nih.gov/ghs/#_prec) for further detail_<br>
