...
The chemical coating on receipt paper causes it to be non-recyclable[^8] [^18] [^21]. 
The potential for BPA and BPS to leach into the environment poses significant concerns[^8] [^21].
Moreover, the slender nature of the paper and its chemical composition make it unsuitable for conventional recycling processes[^8] [^21].
